# Review of OO and SQL

## Project created for the purposes of review and study of the following concepts 
...
- Access data in a relational database and instantiate corresponding objects
...
## Creation and instantiation of the database
```sql
